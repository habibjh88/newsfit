...
var App = /*#__PURE__*/function () {
  function App($) {
    ...
    $(document).ready(function () {
      _this.readyFunctionality($);
      _this.menuDrawerOpen($);
      _this.offcanvasMenuToggle($);
      _this.headerSearchOpen($);
      _this.backToTop($);
      _this.menuOffset($);
    });
    ...
    $(window).on('scroll', function (event) {
      _this.headerSticky($, event);
      _this.backTopTopScroll($, event);
    });
  ...
  (0,_babel_runtime_helpers_createClass__WEBPACK_IMPORTED_MODULE_1__["default"])(App, [{
    ...
    key: "headerSticky",
    value: function headerSticky($, event) {
    ...
    key: "readyFunctionality",
    value: function readyFunctionality($) {
      var siteHeader = $('.site-header');
      var paddingTop = siteHeader.height() + siteHeader.position().top + 10;
      $('.has-trheader .newsfit-breadcrumb-wrapper').css({
        'paddingTop': paddingTop + 'px',
        'opacity': 1
      });
      var commentBody = $('.comment-list .comment-body').last().addClass('last-item');
    }
  }, {
    key: "menuDrawerOpen",
    value: function menuDrawerOpen($) {
      var _this2 = this;
      this.offCanvas.menuBar.on('click', function (e) {
        e.preventDefault();
        _this2.offCanvas.menuBar.toggleClass('is-open');
        _this2.offCanvas.drawer.toggleClass('is-open');
        e.stopPropagation();
      });
      $(document).on('click', function (e) {
        if (!$(e.target).closest(_this2.offCanvas.drawerClass).length) {
          _this2.offCanvas.drawer.removeClass('is-open');
          _this2.offCanvas.menuBar.removeClass('is-open');
        }
      });
    }
  }, {
    key: "offcanvasMenuToggle",
    value: function offcanvasMenuToggle($) {
    ...
    key: "headerSearchOpen",
    value: function headerSearchOpen($) {
    ...
    key: "backTopTopScroll",
    value: function backTopTopScroll($, event) {
...
/******/ 		}
/******/ 		
/******/ 		var chunkLoadingGlobal = self["webpackChunknewsfit"] = self["webpackChunknewsfit"] || [];
