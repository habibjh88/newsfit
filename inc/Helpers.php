...
if ( ! function_exists( 'newsfit_get_svg' ) ) {
	...
	function newsfit_get_svg( $name ) {
		...
		$svg_list = apply_filters( 'newsfit_svg_icon_list', [
			'search'           => '<svg xmlns="http://www.w3.org/2000/svg" height="16" width="16" viewBox="0 0 16 16" ><path fill-rule="evenodd" clip-rule="evenodd" d="M11.4204 13.1709C10.2402 14.0039 8.80078 14.4932 7.24658 14.4932C3.24463 14.4932 0 11.2485 0 7.24658C0 3.24463 3.24463 0 7.24658 0C11.2485 0 14.4932 3.24463 14.4932 7.24658C14.4932 8.97559 13.8872 10.564 12.8765 11.8096C12.8906 11.8213 12.9043 11.833 12.918 11.8452L15.5518 14.2441C15.9629 14.6182 15.9927 15.2544 15.6187 15.665C15.2441 16.0757 14.6084 16.1055 14.1978 15.7314L11.5635 13.3325C11.5093 13.2827 11.4614 13.2285 11.4204 13.1709ZM12.9932 7.24658C12.9932 10.4204 10.4204 12.9932 7.24658 12.9932C4.07275 12.9932 1.5 10.4204 1.5 7.24658C1.5 4.07275 4.07275 1.5 7.24658 1.5C10.4204 1.5 12.9932 4.07275 12.9932 7.24658Z"/></svg>',
